...
@protocol USHImagePickerDelegate;

@interface USHImagePicker : NSObject<UINavigationControllerDelegate,
                                     UIImagePickerControllerDelegate,
                                     UIActionSheetDelegate,
                                     UIPopoverControllerDelegate> 

- (id) initWithController:(UIViewController<USHImagePickerDelegate> *)controller;
- (void) showImagePickerForRect:(CGRect)rect resize:(BOOL)resize width:(CGFloat)width;

@end

@protocol USHImagePickerDelegate <NSObject>
